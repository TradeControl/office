...
namespace docAcknowledgement
{
    class DocLoader
    {
        ...
        public bool LoadAcknowledgement()
        {
            try
            {
                ...
                WriteControl("ContactName2", taskRow.ContactName);
                ...
                WriteControl("TaskTitle2", taskRow.IsTaskTitleNull() ? string.Empty : taskRow.TaskTitle);
